  ...
  return (
    <section id="faq" className="luxury-container py-20 sm:py-24">
      ...
      >
        ...
        <h2 className="section-title mt-4 font-[var(--font-playfair)]">Construction Questions, Clearly Answered</h2>
      </motion.div>
          ...
          return (
            <motion.article
              ...
              className={`rounded-xl border bg-white/80 p-4 shadow-luxury backdrop-blur sm:p-5 ${
                isOpen ? "border-sand/45 border-l-[3px]" : "border-charcoal/8 border-l-[3px] border-l-transparent"
              }`}
            >
              <button
