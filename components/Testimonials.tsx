    ...
    <section id="testimonials" className="bg-charcoal py-20 text-offwhite sm:py-24">
      <div className="luxury-container">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-4 font-[var(--font-playfair)] text-3xl sm:text-4xl">What Clients Say About Desert Horizon</h2>
        </div>
            ...
            {testimonials.map((item, index) => (
              <button
                ...
                className={`h-2.5 rounded-full transition ${
                  active === index ? "w-10 bg-sand" : "w-2.5 bg-offwhite/30 hover:bg-offwhite/45"
                }`}
