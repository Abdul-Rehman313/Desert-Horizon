      ...
      <div className="luxury-container grid gap-8 lg:grid-cols-[1.2fr_1fr]">
        <div>
          ...
          <p className="mt-4 max-w-2xl text-sm leading-relaxed text-offwhite/80 sm:text-base">
            Our teams execute end-to-end outdoor and lifestyle projects for discerning homeowners,
            developers, and hospitality clients across the UAE’s key northern hubs.
          </p>
        ...
        <div className="relative h-64 overflow-hidden rounded-2xl border border-sand/35 bg-gradient-to-br from-[#202020] via-[#2b2b2b] to-[#111] p-6">
          ...
          <p className="font-[var(--font-playfair)] text-xl text-sand">Project Coverage Map</p>
          <p className="mt-2 text-sm text-offwhite/75">Dedicated execution teams in all three emirates.</p>
        </div>
      </div>
    </section>
  );
