...
const serviceBlocks = [
  {
    ...
    points: [
      "Luxury exterior builds",
      "Pool and landscape execution",
      "Material-led quality assurance",
    ],
    image:
  ...
  },
  {
    ...
    points: [
      "2D and 3D concept planning",
      "Budget and timeline coordination",
      "Permit-aligned documentation",
    ],
    image:
  ...
  },
  {
    ...
    points: [
      "Foundation and steel works",
      "Load-focused engineering",
      "Site-specific structural detailing",
    ],
    image:
  ...
  },
  {
    ...
    points: [
      ...
      "Milestone inspection workflows",
      "Final handover assurance",
    ],
    image:
      ...
      <div className="luxury-container">
        <div className="max-w-3xl">
          ...
          <h2 className="section-title mt-4 font-[var(--font-playfair)]">
            Precision Services, Boutique Delivery
          </h2>
        </div>
        <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {serviceBlocks.map((service, index) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="font-[var(--font-playfair)] text-2xl text-charcoal">
                  {service.title}
                </h3>
